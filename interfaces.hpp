...
public:
    ...
    //
    virtual ResultadoEspecifico desenvolvedorDeVocab(const string&) throw(runtime_error)= 0; //SUCESSO: existe vocab,  FALHA: nao existe vocab OU vocab ja tem 10 dsv's
